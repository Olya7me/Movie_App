...
const seriesTitle = document.querySelector(
  ".tv-series-page__series h2.tv-series-page__series-title"
);
  ...
  seriesItems.innerHTML = `
    <div class="tv-series-page__series-skeleton-wrapper">
        <div class="tv-series-page__series-skeleton-container">
            ${[...Array(10)]
              .map(
                () => `<div class="tv-series-page__series-skeleton-item"></div>`
              )
              .join("")}
        </div>
    </div>
...
function createSeriesElement(series) {
  ...
  seriesElement.innerHTML = `
        ...
        <div class="tv-series-page__series-item-info">
            ...
            <p class="tv-series-page__series-item-genre">${series.genres
