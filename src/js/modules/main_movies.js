...
export const apiPopularMoviesUrl =
  "https://kinopoiskapiunofficial.tech/api/v2.2/films/collections?type=TOP_POPULAR_MOVIES&page=2";
export const popularMoviesTitle = document.querySelector(
  ".popular-movies__title"
);
export const popularMoviesItems = document.querySelector(
  ".popular-movies__items"
);

export const apiSeasonUrl =
...
function createUniversalMovieEl(movie) {
  ...
  movieElement.innerHTML = `
        <img class="item-image" src="${movie.posterUrlPreview}" alt="${
    movie.nameRu
  }">
        ...
        <div class="item-info">
            ...
            <p class="item-genre">${movie.genres
