...
const trailerContainer = document.querySelector(
  ".movie-card__container-for-trailer"
);
...
async function renderMovieDetails(movieId) {
  ...
  const countries =
    movie.countries?.map((c) => c.country).join(", ") || "Страна не указана";
  const genres =
    movie.genres?.map((g) => g.genre).join(", ") || "Жанры не указаны";
  ...
  movieContent.innerHTML = `
            ...
            <div class="movie-card__wrapper">
                <div class="movie-card__context">
                    ...
                    <p class="movie-card__context-description">${
                ...
                <div class="movie-card__info">
                    ...
                    <div class="movie-card__info-wrapper">
                        ...
                        <div class="movie-card__info-rating"><p class="gray">Рейтинг</p><p>${
...
async function loadMovieData(movieId) {
  ...
  try {
    ...
    if (videoId) {
      ...
      setInnerHTML(
        ".movie-card__container-for-trailer",
        "<p>Не удалось получить ID видео из ссылки.</p>"
      );
    }
  } catch (error) {
    movieTitle.textContent = error.message;
